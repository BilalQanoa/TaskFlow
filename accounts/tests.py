...
class CompanyRegistrationTests(TestCase):
    ...
    def test_register_and_login_views_work_with_named_urls(self):
        ...
        self.assertRedirects(register_result, reverse('dashboard:dashboard'))
        ...
        self.assertRedirects(login_result, reverse('dashboard:dashboard'))
    ...
    def test_admin_dashboard_shows_only_company_metrics(self):
        ...
        Task.objects.create(company=company, title='Close sprint', status='completed', priority='medium', due_date='2026-06-18')
